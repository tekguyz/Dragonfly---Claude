...
export default function EventsSection() {
  ...
  return (
    <section id="events" className="relative w-full py-32 px-6">
      {/* Background */}
      <div className="absolute inset-0 z-0 bg-[#0D0D0D]">
        <div 
          className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=1920&q=80')] bg-cover bg-center opacity-20"
        />
