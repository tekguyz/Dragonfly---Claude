...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="py-24 px-6 relative">
      {/* Background */}
      <div className="absolute inset-0 z-0" style={{ background: 'radial-gradient(ellipse at 30% 50%, rgba(212,175,55,0.04) 0%, #0A0A0A 60%)' }} />
        ...
        <div>
          ...
          {isSuccess ? (
            ...
            <form 
              ...
              className={`glass-card ${error ? 'border-red-500/50' : ''} p-8 space-y-6`}
              data-netlify="true"
            ...
            >
              ...
              <div>
                ...
                <input 
                  ...
                  name="name" 
                  required 
                  className="w-full bg-background border border-border-subtle rounded-xl px-4 py-3 text-white focus:outline-none focus:border-primary transition-colors"
                />
              </div>
              ...
              <div>
                <label htmlFor="type" className="block text-sm font-medium text-textMuted mb-2">{t('contact.form.type')}</label>
                <select 
                  id="type" 
                  name="type" 
                  className="w-full bg-background border border-border-subtle rounded-xl px-4 py-3 text-white focus:outline-none focus:border-primary transition-colors appearance-none"
                >
                  <option value="General Question">{t('contact.form.type.general')}</option>
                  <option value="Reservation">{t('contact.form.type.reservation')}</option>
                  <option value="Private Event">{t('contact.form.type.event')}</option>
                  <option value="Menu Information">{t('contact.form.type.menu')}</option>
              ...
              <div>
                ...
                <textarea 
                  ...
                  rows={4} 
                  required 
                  className="w-full bg-background border border-border-subtle rounded-xl px-4 py-3 text-white focus:outline-none focus:border-primary transition-colors resize-none"
                ></textarea>
              </div>
