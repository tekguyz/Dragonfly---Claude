...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="py-16 md:py-24 px-4 md:px-6 relative border-t border-border-subtle">
      {/* Background */}
